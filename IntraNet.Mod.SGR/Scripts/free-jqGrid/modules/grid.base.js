...
(function (global, factory) {
	...
	var englishLanguageDefaults = {
		...
		defaults: {
			...
			pgfirst: "Primeira Pagina",
			pglast: "Última Pagina",
			pgnext: "Proxima pagina",
			pgprev: "Pagina Anterior",
			pgrecs: "Records per Page",
			showhide: "Expandindo grid",
			savetext: "Salvando..."
		},
		search: {
			caption: "Pesquisando...",
		...
		edit: {
			...
			bCancel: "Cancelar",
			bClose: "Fechar",
			saveData: "Registro modificado! Deseja salvar?",
			bYes: "Sim",
			bNo: "Não",
			bExit: "Cancelar",
			msg: {
		...
		del: {
			caption: "Deletar",
			msg: "Deseja remover esse registro?",
			bSubmit: "Deletar",
			bCancel: "Cancelar"
		},
		nav: {
			...
			deltext: "",
			deltitle: "Deletar registro",
			searchtext: "",
			searchtitle: "Find records",
			refreshtext: "",
			refreshtitle: "Reload Grid",
			alertcap: "Warning",
			alerttext: "Selecione o registro",
			viewtext: "",
